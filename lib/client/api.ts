 ...
 *
 * @export
 * @interface TweetsLikingUsersLookupResponse
 */
export interface TweetsLikingUsersLookupResponse {
    /**
     *
     * @type {Array<User>}
     * @memberof TweetsLikingUsersLookupResponse
     */
    data?: Array<User>;
    /**
     *
    ...
    /**
     *
     * @type {TweetsLikingUsersLookupResponseMeta}
     * @memberof TweetsLikingUsersLookupResponse
     */
    meta?: TweetsLikingUsersLookupResponseMeta;
}
/**
 *
 * @export
 * @interface TweetsLikingUsersLookupResponseMeta
 */
export interface TweetsLikingUsersLookupResponseMeta {
    /**
     * The number of user results returned in this response
     * @type {number}
     * @memberof TweetsLikingUsersLookupResponseMeta
     */
    result_count?: number;
}
/**
 ...
 *
 * @export
 * @interface UsersBlockingLookupResponse
 */
export interface UsersBlockingLookupResponse {
    /**
     *
     * @type {Array<User>}
     * @memberof UsersBlockingLookupResponse
     */
    data?: Array<User>;
    /**
     *
    ...
    /**
     *
     * @type {UsersBlockingLookupResponseMeta}
     * @memberof UsersBlockingLookupResponse
     */
    meta?: UsersBlockingLookupResponseMeta;
}
/**
 *
 * @export
 * @interface UsersBlockingLookupResponseMeta
 */
export interface UsersBlockingLookupResponseMeta {
    /**
     * The previous token
     * @type {string}
     * @memberof UsersBlockingLookupResponseMeta
     */
    previous_token?: string;
    /**
     * The next token
 ...
 *
 * @export
 * @interface UsersFollowersLookupResponse
 */
export interface UsersFollowersLookupResponse {
    /**
     *
     * @type {Array<User>}
     * @memberof UsersFollowersLookupResponse
     */
    data?: Array<User>;
    /**
     *
...
/**
 * CountsApi - axios parameter creator
 * @export
 */
export const CountsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
...
/**
 * CountsApi - functional programming interface
 * @export
 */
export const CountsApiFp = function (configuration?: Configuration) {
    const localVarAxiosParamCreator = CountsApiAxiosParamCreator(configuration)
    return {
        /**
         * Returns Tweet Counts that match a search query.
         * @summary Full archive search counts
...
/**
 * CountsApi - factory interface
 * @export
 */
export const CountsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = CountsApiFp(configuration)
    return {
        /**
         * Returns Tweet Counts that match a search query.
         * @summary Full archive search counts
...
/**
 * CountsApi - object-oriented interface
 * @export
 * @class CountsApi
 * @extends {BaseAPI}
 */
export class CountsApi extends BaseAPI {
    /**
     * Returns Tweet Counts that match a search query.
     * @summary Full archive search counts
     * @param {string} query One query/rule/filter for matching Tweets. Up to 2048 characters.
    ...
    public tweetCountsFullArchiveSearch(query: string, startTime?: string, endTime?: string, sinceId?: string, untilId?: string, nextToken?: string, granularity?: Granularity, options?: any) {
        return CountsApiFp(this.configuration).tweetCountsFullArchiveSearch(query, startTime, endTime, sinceId, untilId, nextToken, granularity, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public tweetCountsRecentSearch(query: string, startTime?: string, endTime?: string, sinceId?: string, untilId?: string, nextToken?: string, granularity?: Granularity, options?: any) {
        return CountsApiFp(this.configuration).tweetCountsRecentSearch(query, startTime, endTime, sinceId, untilId, nextToken, granularity, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const UsersApiFp = function (configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async tweetsIdLikingUsers(id: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TweetsLikingUsersLookupResponse>> {
         ...
         * @throws {RequiredError}
         */
        async usersIdBlocking(id: string, maxResults?: number, paginationToken?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsersBlockingLookupResponse>> {
         ...
         * @throws {RequiredError}
         */
        async usersIdFollowers(id: string, maxResults?: number, paginationToken?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsersFollowersLookupResponse>> {
...
export const UsersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        tweetsIdLikingUsers(id: string, options?: any): AxiosPromise<TweetsLikingUsersLookupResponse> {
         ...
         * @throws {RequiredError}
         */
        usersIdBlocking(id: string, maxResults?: number, paginationToken?: string, options?: any): AxiosPromise<UsersBlockingLookupResponse> {
         ...
         * @throws {RequiredError}
         */
        usersIdFollowers(id: string, maxResults?: number, paginationToken?: string, options?: any): AxiosPromise<UsersFollowersLookupResponse> {
